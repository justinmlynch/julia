...
function load_juliarc()
    ...
    if !isempty(Base.SYSCONFDIR) && isfile(joinpath(JULIA_HOME,Base.SYSCONFDIR,"julia",vers,"juliarc.jl"))
        include(abspath(JULIA_HOME,Base.SYSCONFDIR,"julia",vers,"juliarc.jl"))
    else
        try_include(abspath(JULIA_HOME,"..","etc","julia",vers,"juliarc.jl"))
    end
